...
class Ui_Base_LoadThemAll(object):
    def setupUi(self, Base_LoadThemAll):
        ...
        self.groupBoxDateModified = QtGui.QGroupBox(Base_LoadThemAll)
        self.groupBoxDateModified.setCheckable(True)
        self.groupBoxDateModified.setChecked(False)
        self.groupBoxDateModified.setObjectName(_fromUtf8("groupBoxDateModified"))
        self.horizontalLayout_4 = QtGui.QHBoxLayout(self.groupBoxDateModified)
        self.horizontalLayout_4.setObjectName(_fromUtf8("horizontalLayout_4"))
        self.cboDateComparison = QtGui.QComboBox(self.groupBoxDateModified)
        self.cboDateComparison.setMaximumSize(QtCore.QSize(100, 16777215))
        self.cboDateComparison.setObjectName(_fromUtf8("cboDateComparison"))
        self.horizontalLayout_4.addWidget(self.cboDateComparison)
        self.dtDateTime = QtGui.QDateTimeEdit(self.groupBoxDateModified)
        self.dtDateTime.setButtonSymbols(QtGui.QAbstractSpinBox.UpDownArrows)
        self.dtDateTime.setAccelerated(True)
        self.dtDateTime.setDateTime(QtCore.QDateTime(QtCore.QDate(2017, 1, 1), QtCore.QTime(0, 0, 0)))
        self.dtDateTime.setCurrentSection(QtGui.QDateTimeEdit.DaySection)
        self.dtDateTime.setCalendarPopup(True)
        self.dtDateTime.setObjectName(_fromUtf8("dtDateTime"))
    ...
    def retranslateUi(self, Base_LoadThemAll):
        ...
        self.groupBoxDateModified.setTitle(_translate("Base_LoadThemAll", "Date modified filter", None))
        self.dtDateTime.setDisplayFormat(_translate("Base_LoadThemAll", "ddd dd MMM yyyy hh:mm AP", None))
