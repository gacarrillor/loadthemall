...
# Form implementation generated from reading ui file 'ui/Ui_DockWidget.ui'
#
...
class Ui_DockWidget(object):
    def setupUi(self, DockWidget):
        ...
        self.groupBoxGeometryTypeFilter.setToolTip("")
        ...
        self.verticalLayout_51 = QtWidgets.QVBoxLayout(self.tabPointCloud)
        self.verticalLayout_51.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_51.setObjectName("verticalLayout_51")
        self.scrollArea_21 = QtWidgets.QScrollArea(self.tabPointCloud)
        ...
        self.scrollAreaWidgetContents_41.setGeometry(QtCore.QRect(0, 0, 322, 556))
        self.scrollAreaWidgetContents_41.setObjectName("scrollAreaWidgetContents_41")
        self.gridLayout_111 = QtWidgets.QGridLayout(self.scrollAreaWidgetContents_41)
        self.gridLayout_111.setObjectName("gridLayout_111")
        self.stackedWidgetPointCloud = QtWidgets.QStackedWidget(self.scrollAreaWidgetContents_41)
        self.stackedWidgetPointCloud.setMinimumSize(QtCore.QSize(0, 488))
        self.stackedWidgetPointCloud.setObjectName("stackedWidgetPointCloud")
        self.page_71 = QtWidgets.QWidget()
        self.page_71.setObjectName("page_71")
        self.stackedWidgetPointCloud.addWidget(self.page_71)
        self.page_81 = QtWidgets.QWidget()
        self.page_81.setObjectName("page_81")
        self.stackedWidgetPointCloud.addWidget(self.page_81)
        self.gridLayout_111.addWidget(self.stackedWidgetPointCloud, 0, 0, 1, 1)
        self.groupBoxPointCloudsCrs = QtWidgets.QGroupBox(self.scrollAreaWidgetContents_41)
        self.groupBoxPointCloudsCrs.setEnabled(True)
        self.groupBoxPointCloudsCrs.setCheckable(True)
        self.groupBoxPointCloudsCrs.setChecked(False)
        self.groupBoxPointCloudsCrs.setObjectName("groupBoxPointCloudsCrs")
        self.gridLayout_101 = QtWidgets.QGridLayout(self.groupBoxPointCloudsCrs)
        self.gridLayout_101.setContentsMargins(10, 9, -1, 9)
        self.gridLayout_101.setObjectName("gridLayout_101")
        self.pointCloudCrs = QgsProjectionSelectionWidget(self.groupBoxPointCloudsCrs)
        self.pointCloudCrs.setObjectName("pointCloudCrs")
        self.gridLayout_101.addWidget(self.pointCloudCrs, 0, 0, 1, 1)
        self.gridLayout_111.addWidget(self.groupBoxPointCloudsCrs, 1, 0, 1, 1)
        self.scrollArea_21.setWidget(self.scrollAreaWidgetContents_41)
        self.verticalLayout_51.addWidget(self.scrollArea_21)
        self.tabWidget.addTab(self.tabPointCloud, "")
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 348, 529))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout_14.addItem(spacerItem1, 14, 0, 1, 1)
        ...
        self.gridLayout_14.addWidget(self.chkCaseInsensitive, 7, 0, 1, 1)
        ...
        self.gridLayout_14.addItem(spacerItem2, 10, 0, 1, 1)
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        spacerItem3 = QtWidgets.QSpacerItem(25, 10, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        ...
        self.gridLayout_14.addLayout(self.horizontalLayout_3, 6, 0, 1, 1)
        ...
        self.gridLayout_14.addWidget(self.groupBox_2, 11, 0, 1, 1)
        ...
        self.gridLayout_14.addWidget(self.chkDoNotEmpty, 4, 0, 1, 1)
        ...
        self.gridLayout_14.addWidget(self.chkSort, 5, 0, 1, 1)
        ...
        self.gridLayout_14.addWidget(self.chkAccentInsensitive, 8, 0, 1, 1)
        ...
        self.gridLayout_14.addWidget(self.chkLayersOff, 3, 0, 1, 1)
        ...
        self.gridLayout_14.addWidget(self.groupBox, 13, 0, 1, 1)
        self.chkSearchInZIPs = QtWidgets.QCheckBox(self.scrollAreaWidgetContents_2)
        self.chkSearchInZIPs.setObjectName("chkSearchInZIPs")
        self.gridLayout_14.addWidget(self.chkSearchInZIPs, 2, 0, 1, 1)
    ...
    def retranslateUi(self, DockWidget):
        ...
        self.groupBoxPointCloudsCrs.setTitle(_translate("DockWidget", "Set CRS to all Point Cloud Layers"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabPointCloud), _translate("DockWidget", "Point Cloud"))
...
"same folder name (e.g., my_group.qml), it will be applied to all layers inside that group."))
        ...
        self.chkSearchInZIPs.setToolTip(_translate("DockWidget", "<html><head/><body><p>Supported compressed files:</p><p>ZIP, Gzip (.gz), 7zip (.7z), TAR, and RAR.</p><p><br/></p><p><span style=\" font-style:italic;\">For 7zip: Module \'py7zr\' is required.</span></p><p><span style=\" font-style:italic;\">For RAR: Module \'rarfile\' is required.</span></p></body></html>"))
        self.chkSearchInZIPs.setText(_translate("DockWidget", "Also search inside compressed files"))
        ...
        self.label.setText(_translate("DockWidget", "Copyright (C) 2010-2023 Germán Carrillo"))
        self.label_3.setText(_translate("DockWidget", "<i>Licensed under the terms of GNU GPL 2</i>"))
        self.label_7.setText(_translate("DockWidget", "<html><head/><body><p><span style=\" font-style:italic;\">Code contributors:</span><br/><br/>&nbsp;&nbsp;&nbsp;&nbsp;David Bakeman (v2.1 and v2.4)<br/>&nbsp;&nbsp;&nbsp;&nbsp;Soeren Gebbert (v2.3)<br/>&nbsp;&nbsp;&nbsp;&nbsp;Jean Hemmi (v3.1 &amp; French transl.)<br/>&nbsp;&nbsp;&nbsp;&nbsp;Guillaume Lostis (v3.3)<br/>&nbsp;&nbsp;&nbsp;&nbsp;Jan Caha (v3.5)</p></body></html>"))
