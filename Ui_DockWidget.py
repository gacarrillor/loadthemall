...
class Ui_DockWidget(object):
    def setupUi(self, DockWidget):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, -93, 322, 579))
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 348, 515))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"same folder name (e.g., my_group.qml), it will be applied to all layers inside that group."))
        ...
        self.label.setText(_translate("DockWidget", "Copyright (C) 2010-2021 Germán Carrillo"))
        self.label_3.setText(_translate("DockWidget", "<i>Licensed under the terms of GNU GPL 2</i>"))
        self.label_7.setText(_translate("DockWidget", "<html><head/><body><p><span style=\" font-style:italic;\">Code contributors:</span><br/><br/>&nbsp;&nbsp;&nbsp;&nbsp;David Bakeman (v2.1 and v2.4)<br/>&nbsp;&nbsp;&nbsp;&nbsp;Soeren Gebbert (v2.3)<br/>&nbsp;&nbsp;&nbsp;&nbsp;Jean Hemmi (v3.1 &amp; French transl.)<br/>&nbsp;&nbsp;&nbsp;&nbsp;Guillaume Lostis (v3.3)</p></body></html>"))
