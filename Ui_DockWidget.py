...
class Ui_DockWidget(object):
    ...
    def retranslateUi(self, DockWidget):
        ...
        self.chkStyles.setToolTip(_translate("DockWidget", "When checked, if a QML file shares a layer\'s name and path, it will be applied. If groups are checked and a QML has the group name, it will be applied to all layers inside that group."))
        self.chkStyles.setText(_translate("DockWidget", "Apply layer style"))
